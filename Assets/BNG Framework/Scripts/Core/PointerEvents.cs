...
namespace BNG {
    public class PointerEvents : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler {
        ...
        public virtual void OnPointerEnter(PointerEventData eventData) {
            ...
            HapticsManager.Instance.OneShotVibration(HapticsManager.VibrationPreset.OnTouch);
        }
        ...
        public virtual void OnPointerUp(PointerEventData eventData) {
            ...
            HapticsManager.Instance.OneShotVibration(HapticsManager.VibrationPreset.OnComplete);
        }
